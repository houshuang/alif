...
| GET | `/api/stats/analytics` | Full analytics (pace, CEFR estimate, daily history, daily goal with main/slow maintenance lanes, frequency-core top-N coverage/confidence/unmapped counts and next gaps) |
