...
- **Comprehensibility gate** — ≥60% known scaffold words required. All acquiring words count as known (they've been introduced). Familiar encountered words (total_encounters >= `FAMILIAR_ENCOUNTER_THRESHOLD` = 8) also count as known. Low-encounter encountered words are excluded.
