...
_ADDITIVE_COLUMN_DELTAS: list[tuple[str, str, str]] = [
    ...
    ("sentences", "quality_reviewed_at", "DATETIME"),
    ("sentences", "quality_natural", "BOOLEAN"),
    ("sentences", "quality_translation_correct", "BOOLEAN"),
    ("sentences", "quality_reason", "TEXT"),
    ...
    ("user_lemma_knowledge", "clean_exposures", "INTEGER DEFAULT 0"),
