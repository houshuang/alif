...
- [TODO] Curate the remaining 14 page-68 contextual-verifier flags individually. Seven have plausible gated destinations (`قَوْم`, relative `الَّذِي`, `مَلِك`, `أَيّ`); seven require a canonical homograph/new fully enriched lemma (`سُلَّم` stairs, `أَكِيد`, `عَدَّ` count, `إِبَادَة`, `أَحَد` someone, `خَيَال`, `اِشْتَقَّ`). Do not bulk-apply: independently verify each surface/context and preserve exact preimages.
