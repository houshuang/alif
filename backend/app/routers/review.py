...
def submit_sentence(body: SentenceReviewSubmitIn, db: Session = Depends(get_db)):
    ...
    result = submit_sentence_review(
        ...
        confusion_captures=[c.model_dump() for c in body.confusion_captures],
    ...
    log_interaction(
        ...
        confused_lemma_ids=body.confused_lemma_ids,
        confusion_candidate_lemma_ids=body.confusion_candidate_lemma_ids,
        confusion_captures_count=len(body.confusion_captures),
        response_ms=body.response_ms,
        session_id=body.session_id,
        review_mode=body.review_mode,
        ...
        try:
            if item.type == "sentence":
                ...
                result = submit_sentence_review(
                    ...
                    confusion_captures=payload.get("confusion_captures") or [],
